...
// Fetch user's workout logs from the database
...
// Weather API setup (Orlando or any city)
$apiKey = "a56845750dc537464961fede2e54f3e5";  // Your OpenWeatherMap API key
$city = "Orlando";  // City name (you can change this to any city)
$apiUrl = "http://api.openweathermap.org/data/2.5/weather?q=$city&appid=$apiKey&units=imperial";  // Imperial for Fahrenheit and mph
...
<body>
    ...
    <!-- Weather Widget Box (Separate from Main Content) -->
